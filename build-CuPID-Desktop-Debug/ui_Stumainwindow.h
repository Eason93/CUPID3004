...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_7->setGeometry(QRect(460, 300, 99, 27));
        pushButton_8 = new QPushButton(centralWidget);
        pushButton_8->setObjectName(QStringLiteral("pushButton_8"));
        pushButton_8->setGeometry(QRect(460, 260, 99, 27));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_7->setText(QApplication::translate("MainWindow", "Ablity Check", 0));
        pushButton_8->setText(QApplication::translate("MainWindow", "Course Check", 0));
